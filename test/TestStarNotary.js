...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Another awesome Star!', tokenId2, {from: accounts[1]})
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(await instance.lookUptokenIdToStarInfo(tokenId), 'Another awesome Star!')
    assert.equal(await instance.lookUptokenIdToStarInfo(99), '')
});